    ...
    <div className="min-h-screen flex flex-col bg-mesh">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">Split PDF into individual pages</p>
        </div>
        ...
        <div className="max-w-4xl mx-auto mt-12 grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            <h3 className="font-semibold text-gray-900 mb-2">Page by Page</h3>
            <p className="text-gray-600">Split into individual pages</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            <h3 className="font-semibold text-gray-900 mb-2">Custom Ranges</h3>
            <p className="text-gray-600">Extract specific page ranges</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            <h3 className="font-semibold text-gray-900 mb-2">Batch Download</h3>
            <p className="text-gray-600">Download all pages at once</p>
          </div>
        </div>
      </main>
