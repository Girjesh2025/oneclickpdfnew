    ...
    <div className="min-h-screen flex flex-col bg-mesh">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">Combine multiple PDF files into one</p>
        </div>
        ...
        <div className="max-w-4xl mx-auto mt-12 grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            ...
            <p className="text-gray-600">Combine up to 10 PDF files</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            <h3 className="font-semibold text-gray-900 mb-2">Preserve Quality</h3>
            <p className="text-gray-600">Maintains original quality</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            <h3 className="font-semibold text-gray-900 mb-2">Fast Processing</h3>
            <p className="text-gray-600">Quick merge operation</p>
          </div>
        </div>
      </main>
